...
async def twitter_handler(Mbot, message):
   try:            
      ...
      try:
          dump_file = await message.reply_video(link,caption="Спасибо за использование - @OKAsave_bot")
             ...
             await snd_message.delete()
              ...
              try:
                  ...
                  try:
                     ...
                     await asyncio.sleep(1)
                     await message.reply_video(content_value,caption="Спасибо за использование - @OKAsave_bot")
                     await snd_msg.delete()
                  except Exception as e:
                      print(e)
                      await message.reply("К сожалению, неверная ссылка или носитель недоступен:)")
   except Exception as e:
        print(e)
        if LOG_GROUP:
